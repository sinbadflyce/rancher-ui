...
export default Controller.extend({
  ...
  init() {
    ...
    $(".cluster-launch ul.breadcrumb li:last-child").removeClass("active");
  ...
  actions: {
    chooseProvider(id) {
      $(".launch-cluster .cluster-driver-box").removeClass("selected");
    ...
    launchProvider() {
      ...
      this.transitionToRoute("clusters.new.launch", classTarget.attr("id"));
    }
  },
